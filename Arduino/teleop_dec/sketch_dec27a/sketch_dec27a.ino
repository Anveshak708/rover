...
// Motor driver pins
const int LEFT_MOTOR_PWM = 5;   // PWM pin for left motor
const int LEFT_MOTOR_DIR = 3;   // Direction pin for left motor
const int RIGHT_MOTOR_PWM = 6;  // PWM pin for right motor
const int RIGHT_MOTOR_DIR = 7;  // Direction pin for right motor
